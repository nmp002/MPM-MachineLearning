...
regression_optimizer = optim.Adam(regression_model.parameters(), lr=1e-3, weight_decay=0.00001)  # L2 regularization
classification_optimizer = optim.Adam(classification_model.parameters(), lr=1e-3, weight_decay=0.00001)
