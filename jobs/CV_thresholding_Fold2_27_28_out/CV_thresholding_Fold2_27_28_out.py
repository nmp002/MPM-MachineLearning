...
#
# This script is for Fold 2 validation, training on Folds 1,3-5.
        ...
        with torch.no_grad():
            ...
            if avg_val_loss < best_val_loss:
                ...
                if patience_counter >= patience:
                    ...
                    # Test the validation fold once training is complete and calculate Fold 2 threshold
                    with open(results_file, 'a') as f:
                        f.write(f'\nTesting model_{i+1} on Fold 2...\n')
                    ...
                    with open(results_file, 'a') as f:
                        f.write(f'\nTesting model_{i+1} on Training Folds (1,3-5)...\n')
                    with torch.no_grad():
                        model.eval()
                        ...
                        with open(results_file, 'a') as f:
                            f.write(f'Fold 2 Training Threshold: {threshold_train}\n')
