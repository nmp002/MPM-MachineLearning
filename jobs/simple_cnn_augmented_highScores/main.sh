...
#SBATCH --job-name=simple_cnn_augmented_highScores
...
rsync -avq $SLURM_SUBMIT_DIR/simple_cnn_augmented_highScores.py /scratch/$SLURM_JOB_ID
...
python3 simple_cnn_augmented_highScores.py
