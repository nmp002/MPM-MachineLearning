...
#
# This script is for Fold 1 validation, training on Folds 2-5.
...
train_ids = ['Sample_002', 'Sample_017', 'Sample_024', 'Sample_026',
        ...
        with torch.no_grad():
            ...
            if avg_val_loss < best_val_loss:
                ...
                if patience_counter >= patience:
                    ...
                    # Test the validation fold once training is complete and calculate Fold 1 threshold
                    with open(results_file, 'a') as f:
                        f.write(f'\nTesting model_{i+1} on Fold 1...\n')
                    ...
                    with torch.no_grad():
                        ...
                        with open(results_file, 'a') as f:
                            f.write(f'Fold 1 Validation Threshold: {threshold}\n')

                    ## Test the training set as well
                    with open(results_file, 'a') as f:
                        f.write(f'\nTesting model_{i+1} on Training Folds (2-5)...\n')
                    with torch.no_grad():
                        model.eval()
                        ...
                        with open(results_file, 'a') as f:
                            f.write(f'Fold 1 Training Threshold: {threshold_train}\n')
