...
#SBATCH --job-name=CV_thresholding_Fold1_27_28_out
...
rsync -avq $SLURM_SUBMIT_DIR/CV_thresholding_Fold1_27_28_out.py /scratch/$SLURM_JOB_ID
...
python3 CV_thresholding_Fold1_27_28_out.py
