...
#SBATCH --job-name=Testing_Model3_CV_threshold
...
rsync -avq $SLURM_SUBMIT_DIR/Testing_Model3_CV_threshold.py /scratch/$SLURM_JOB_ID
...
python3 Testing_Model3_CV_threshold.py
