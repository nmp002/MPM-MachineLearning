...
#SBATCH --job-name=cnn_sample_based_testing_NADH_SHG
...
rsync -avq $SLURM_SUBMIT_DIR/cnn_sample_based_testing_NADH_SHG.py /scratch/$SLURM_JOB_ID
...
python3 cnn_sample_based_testing_NADH_SHG.py
