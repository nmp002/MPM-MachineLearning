...
#
# This script is for Fold 3 validation, training on Folds 1,2,4,5.
...
train_ids = ['Sample_004', 'Sample_010', 'Sample_014','Sample_023','Sample_025'
             ...
             'Sample_009', 'Sample_015', 'Sample_019', 'Sample_029',
        ...
        with torch.no_grad():
            ...
            if avg_val_loss < best_val_loss:
                ...
                if patience_counter >= patience:
                    ...
                    # Test the validation fold once training is complete and calculate Fold 3 threshold
                    with open(results_file, 'a') as f:
                        f.write(f'\nTesting model_{i+1} on Fold 3...\n')
                    ...
                    with torch.no_grad():
                        ...
                        with open(results_file, 'a') as f:
                            f.write(f'Fold 2 Validation Threshold: {threshold}\n')

                    ## Test the training set as well
                    with open(results_file, 'a') as f:
                        f.write(f'\nTesting model_{i+1} on Training Folds (1,2,4,5)...\n')
                    with torch.no_grad():
                        model.eval()
                        ...
                        with open(results_file, 'a') as f:
                            f.write(f'Fold 3 Training Threshold: {threshold_train}\n')
