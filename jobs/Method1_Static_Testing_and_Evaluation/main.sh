...
#SBATCH --job-name=Method1_Static_Testing_and_Evaluation
...
rsync -avq $SLURM_SUBMIT_DIR/Method1_Static_Testing_and_Evaluation.py /scratch/$SLURM_JOB_ID
...
python3 Method1_Static_Testing_and_Evaluation.py
