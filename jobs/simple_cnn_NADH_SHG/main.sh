...
#SBATCH --job-name=simple_cnn_NADH_SHG
...
rsync -avq $SLURM_SUBMIT_DIR/simple_cnn_NADH_SHG.py /scratch/$SLURM_JOB_ID
...
rsync -avq /home/nmp002/MPM-MachineLearning/scripts/old_dataset_loader.py /scratch/$SLURM_JOB_ID/scripts
...
python3 simple_cnn_NADH_SHG.py
