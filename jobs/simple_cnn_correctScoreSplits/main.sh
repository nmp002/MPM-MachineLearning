...
#SBATCH --job-name=simple_cnn_correctScoreSplits
...
rsync -avq $SLURM_SUBMIT_DIR/simple_cnn_correctScoreSplits.py /scratch/$SLURM_JOB_ID
...
python3 simple_cnn_correctScoreSplits.py
