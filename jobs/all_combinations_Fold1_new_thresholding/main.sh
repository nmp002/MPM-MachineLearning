...
#SBATCH --job-name=all_combinations_Fold1_new_thresholding
...
rsync -avq $SLURM_SUBMIT_DIR/all_combinations_Fold1_new_thresholding.py /scratch/$SLURM_JOB_ID
...
python3 all_combinations_Fold1_new_thresholding.py
