...
#SBATCH --job-name=multiclass_SHG
...
rsync -avq $SLURM_SUBMIT_DIR/multiclass_SHG.py /scratch/$SLURM_JOB_ID
mkdir /scratch/$SLURM_JOB_ID/models
rsync -avq /home/nmp002/MPM-MachineLearning/models/multiclass_CNN.py /scratch/$SLURM_JOB_ID/models
