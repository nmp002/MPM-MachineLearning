## Description ##
#
# Leaving out Samples 27 and 29 due to extremely poor performance when they were included.
#
# Performing cross-validation on 22 of the 27 samples,
# leaving out 5 samples for final testing. For each of the 5 folds,
...
#
# This script is for Fold 4 validation, training on Folds 1,2,3,5.
# Fold 1: Samples 4, 10, 14, 23, 25 (High/Low = 2/3)
# Fold 2: Samples 2, 17, 24, 26 (High/Low = 2/2)
# Fold 3: Samples 3, 13, 18, 30 (High/Low = 2/2)
# Fold 4: Samples 9, 15, 19, 29 (High/Low = 2/2)
# Fold 5: Samples 6, 7, 12, 16, 22 (High/Low = 2/3)
#
# Test Set: Samples 1, 5, 8, 11, 20 (High/Low = 2/3)
...
train_ids = ['Sample_004', 'Sample_010', 'Sample_014','Sample_023','Sample_025'
             'Sample_002', 'Sample_017', 'Sample_024', 'Sample_026'
             'Sample_003', 'Sample_013', 'Sample_018', 'Sample_030'
             'Sample_006', 'Sample_007', 'Sample_012', 'Sample_016', 'Sample_022']

# val_ids = ['Sample_004', 'Sample_010', 'Sample_014','Sample_023','Sample_025']  # Fold 1
# val_ids = ['Sample_002', 'Sample_017', 'Sample_024', 'Sample_026']  # Fold 2
# val_ids = ['Sample_003', 'Sample_013', 'Sample_018', 'Sample_030']  # Fold 3
val_ids = ['Sample_009', 'Sample_015', 'Sample_019', 'Sample_029']  # Fold 4
# val_ids = ['Sample_006', 'Sample_007', 'Sample_012', 'Sample_016', 'Sample_022']  # Fold 5
        ...
        with torch.no_grad():
            ...
            if avg_val_loss < best_val_loss:
                ...
                if patience_counter >= patience:
                    ...
                    # Test the validation fold once training is complete and calculate Fold 4 threshold
                    with open(results_file, 'a') as f:
                        f.write(f'\nTesting model_{i+1} on Fold 4...\n')
                    ...
                    with torch.no_grad():
                        ...
                        with open(results_file, 'a') as f:
                            f.write(f'Fold 4 Validation Threshold: {threshold}\n')

                    ## Test the training set as well
                    with open(results_file, 'a') as f:
                        f.write(f'\nTesting model_{i+1} on Training Folds (1,2,3,5)...\n')
                    with torch.no_grad():
                        model.eval()
                        ...
                        with open(results_file, 'a') as f:
                            f.write(f'Fold 4 Training Threshold: {threshold_train}\n')
                    ...
                    ax.legend()
                    fig.tight_layout()
                    fig.savefig(f'model_{i + 1}_loss_epoch{best_epoch + 1}.png')
                    plt.close(fig)
