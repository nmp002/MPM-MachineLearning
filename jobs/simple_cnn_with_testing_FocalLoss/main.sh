...
#SBATCH --job-name=simple_cnn_with_testing_FocalLoss
...
rsync -avq $SLURM_SUBMIT_DIR/simple_cnn_with_testing_FocalLoss.py /scratch/$SLURM_JOB_ID
...
rsync -avq /home/nmp002/MPM-MachineLearning/scripts/loss_functions.py /scratch/$SLURM_JOB_ID/scripts
...
python3 simple_cnn_with_testing_FocalLoss.py
